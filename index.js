...
// the function should receive one argumrnt , an array of javascript

 let superbowlWin = (record) => { let finalResult = record.find(record => record.result === "W") 
...
// let finalResult = record.find(superbowlWin)



// const superbowlWin = (record) => {  const result = record.find( record => record.result === "W" );
